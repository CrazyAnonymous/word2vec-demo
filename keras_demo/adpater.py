...
from utils.text_utils import file_to_text, file_to_words, text_to_words
...
article = file_to_text('../lstm/data/Jane_eyer.txt')
sentences = text_to_words(article)
...
# pd.Series(most_similar(u'喜欢'))

print(most_similar(u'喜欢'))
